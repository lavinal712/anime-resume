...
AnimeResume is a resume builder that allows you to create a resume with your favorite anime characters.

## Visualization

![tomori](./public/resume-example/tomori.png)
...
Thanks to open-resume for providing the template.
